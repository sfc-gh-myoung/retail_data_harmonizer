...
-- Reset for idempotent re-run (first RAW_RETAIL_ITEMS seed file — clears all venues)
TRUNCATE TABLE IF EXISTS HARMONIZER_DEMO.RAW.RAW_RETAIL_ITEMS;
SELECT '[PASS] RAW_RETAIL_ITEMS reset' AS progress;
